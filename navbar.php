...
<body class="bg-image">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
      ...
      <img src="media/icon.png" alt="Bootstrap" width="30" height="24">
    </a>
        <a class="navbar-brand" href="index.php"><strong>BreadHane</strong></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex" role="search">
            ...
            <button class="btn btn-success" type="submit"><strong>Ara</strong></button>
          </form>
        </div>
      </div>
    </nav>
